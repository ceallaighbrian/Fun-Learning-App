...
question17 = Question.create(name: "Tom writes a total of forty words on five blank cards.\nHe writes nine words on each of the first four cards.\nHow many words does Tom write on the last card?", quiz_id: quiz4.id)
...
Answer.create(name: '8 words', correct: false, question_id: question17.id)
Answer.create(name: '9 words', correct: false, question_id: question17.id)
Answer.create(name: '4 words', correct: true, question_id: question17.id)
Answer.create(name: '5 words', correct: false, question_id: question17.id)

Answer.create(name: 'rock', correct: false, question_id: question18.id)
Answer.create(name: 'note', correct: false, question_id: question18.id)
Answer.create(name: 'tone', correct: true, question_id: question18.id)
